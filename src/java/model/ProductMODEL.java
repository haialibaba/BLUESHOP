...
public class ProductMODEL {
    ...
    public ProductMODEL(String idSP, double priceSP, int quantitySP, String id_spnccSP, String nameSP, String categorySP, String brandSP, String descriptionSP, String imageSP, String imageSP1, String imageSP2, String imageSP3, double ratingSP, int discountSP, int id_producer) {
        this.idSP = idSP;
