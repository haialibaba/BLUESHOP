            ...
            if (account != null) {
                ...
                switch (usertype) {
                    case 1:
                        ...
                        String idAdmin = account.getId();
                        if (isValidCookieValue(usernameAdmin) && isValidCookieValue(phoneNumberAdmin)
                                && isValidCookieValue(passAdmin) && isValidCookieValue(idAdmin)) {
                            ...
                            Cookie useridCookie = new Cookie("userid", idAdmin);
                    ...
                    case 2:
                        ...
                        String idEmployee = account.getId();
                        if (isValidCookieValue(usernameEmployee) && isValidCookieValue(phoneNumberEmployee)
                                && isValidCookieValue(passEmployee) && isValidCookieValue(idEmployee)) {
                            ...
                            Cookie useridCookie = new Cookie("userid", idEmployee);
                    ...
                    case 3:
                        ...
                        if (isValidCookieValue(username) && isValidCookieValue(phoneNumber)
                                && isValidCookieValue(pass) && isValidCookieValue(id)) {
